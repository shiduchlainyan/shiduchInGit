...
module.exports = "<div *ngIf=\"cand\">\n  <div class=\"form-group\">\n    <!-- <input type=\"file\" class=\"form-control\" name=\"teacherCV\"data-buttonText=\"צירוף קורות חיים\"/> -->\n    <button type=\"button\" name=\"image\" class=\"btnRegister\" md-button (click)=\"imgFileInput.click()\">הוסף תמונה</button>\n    <input hidden type=\"file\" #imgFileInput (change)=\"addImage ($event)\" />\n\n  </div>\n  {{imageName}}\n  <br>\n  <br><br><br><br>\n\n  <div class=\"form-group\">\n    <!-- <input type=\"file\" class=\"form-control\" name=\"teacherCV\"data-buttonText=\"צירוף קורות חיים\"/> -->\n    <button type=\"button\" name=\"doc\" class=\"btnRegister\" md-button (click)=\"docFileInput.click()\">הוסף מסמך</button>\n    <input hidden type=\"file\" multiple #docFileInput (change)=\"addDoc($event)\" />\n\n\n  </div>\n  <div *ngFor=\"let item of docs\">{{item}}</div>\n\n\n  <div class=\"buttons\">\n    <button type=\"button\" class=\"btn btn-light\" (click)=\"saveDetailCandidate()\"> שמור </button>\n    <button type=\"button\" class=\"btn btn-light\" (click)=\"saveAndContinue()\"> שמור והמשך </button>\n\n  </div>\n</div>"
...
module.exports = "\n\n<form #frm=\"ngForm\" (ngSubmit)=\"submitAll()\">\n\n<button type=\"button\" (click)=\"confidentialityWaiverForm()\">חתימה על טופס ויטור סודיות</button>\n\n\n<p *ngIf=\"!cand?.Candidate?.ConfidentialityWaiverForm&&frm.submitted\">עדיין לא חתמת על טופס ויתור סודיות*</p>\n\n\n<div id=\"paypal-checkout-btn\"></div>\n\n\n<p *ngIf=\"!cand.Candidate.payPal&&frm.submitted\">עדיין לא שילמת דמי רצינות*</p>\n<button *ngIf=\"dCandidateService.allowAcceess==1\" type=\"submit\"> הגשת הבקשה </button>\n\n<button *ngIf=\"dCandidateService.allowAcceess!=1\" type=\"button\" (click)=\"finishByMatcMaker()\"> סיום השלמת פרטים</button>\n\n</form>\n<!-- {{f(frm)}} -->"
...
module.exports = "\n\n<link href=\"//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">\n<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js\"></script>\n<script src=\"//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js\"></script>\n<!------ Include the above in your HEAD tag ---------->\n\n<!-- data-toggle=\"tab\" -->\n <div class=\"container\" dir=\"rtl\">\n              <div class=\"row\">\n                <div class=\"col-xs-12 \">\n                  <nav>\n                    <div class=\"nav nav-tabs nav-fill\" id=\"nav-tab\" role=\"tablist\">\n                      <!-- <a  class=\"nav-item nav-link active\" id=\"nav-PersonalInformation-tab\" routerLink=\"complitDitails\">השלמת פרטי מועמד</a> -->\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-shortcoming-tab\" role=\"tab\"  routerLink=\"complitDitails\">השלמת פרטי מועמד</a>\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-shortcoming-tab\" role=\"tab\"  routerLink=\"calander\">לוח שנה</a>\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-shortcoming-tab\" role=\"tab\"  routerLink=\"allSuggest\">רשימת ההצעות</a>\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-shortcoming-tab\" role=\"tab\"  routerLink=\"allCandidate\">רשימת מועמדים</a>\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-shortcoming-tab\" role=\"tab\"  routerLink=\"mail\">תקשורת עם מועמד</a>\n                      <a  *ngIf=\"dCandidateService.allowAcceess==3\" routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-shortcoming-tab\" role=\"tab\"  routerLink=\"matcMakerRegister\"> הרשמת שדכן</a>\n                        <!-- התאב האחרון מיועד למנמר בלבד -->\n                      \n                    </div>\n                  </nav>\n                  <div class=\"tab-content py-3 px-3 px-sm-0\" id=\"nav-tabContent\">\n                      <div class=\"\" id=\"nav-all\" >\n                          <router-outlet></router-outlet>                   \n                      </div>\n                \n                  </div>\n                \n                </div>\n              </div>\n        </div>\n\n"
...
module.exports = "<link href=\"//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">\n<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js\"></script>\n<script src=\"//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js\"></script>\n<!------ Include the above in your HEAD tag ---------->\n\n<!-- data-toggle=\"tab\" -->\n <div class=\"container\" dir=\"rtl\">\n              <div class=\"row\">\n                <div class=\"col-xs-12 \">\n                  <nav>\n                    <div class=\"nav nav-tabs nav-fill\" id=\"nav-tab\" role=\"tablist\">\n                      <!-- <a  class=\"nav-item nav-link active\" id=\"nav-PersonalInformation-tab\" routerLink=\"pro\">פרטים אישים</a> -->\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-description-tab\"  role=\"tab\"  routerLink=\"suggest\">רשימת ההצעות</a>\n                      <!-- <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-description-tab\"  role=\"tab\"  routerLink=\"details\">פרטים </a> -->\n                      <!-- <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-description-tab\"  role=\"tab\"  routerLink=\"calander\">לוח פגישות</a> -->\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-description-tab\"  role=\"tab\"  routerLink=\"calander\">יומן פגישות</a>\n                      <a  routerLinkActive=\"testActive\" class=\"nav-item nav-link\" id=\"nav-description-tab\"  role=\"tab\"  routerLink=\"mailToMatcmaker\">תקשורת עם שדכן </a>\n                      \n                    </div>\n                  </nav>\n                  <div class=\"tab-content py-3 px-3 px-sm-0\" id=\"nav-tabContent\">\n                      <div class=\"\" id=\"nav-all\" >\n                          <router-outlet></router-outlet>                   \n                      </div>\n                \n                  </div>\n                \n                </div>\n              </div>\n        </div>\n"
...
module.exports = "<!-- <p>\n  suggests works!\n</p>\n\n\n<div *ngFor=\"let user of arrUser;i as index\" style=\"  border: 1px solid  #e74c3c;\">\n  <label>שם פרטי :{{user.FirstName}}</label><br>\n  <label>גיל : {{ getAgeFromDate(user.BornDate)}}</label><br>\n  <label>מצב מישפחתי : {{dCandidateService.GetValue(user.Status)}}</label><br>\n  <label>ארץ מגורים : {{user.CountryId}}</label><br>\n\n  <button (click)=\"GetDetailByTzToSuggestion(user)\">פרטים נוספים</button>\n  <button (click)=\"Interested(dCandidateService.currentCandidate.User,user.Tz)\">מעונין להיפגש</button>\n  <button (click)=\"NotInterseted(dCandidateService.currentCandidate.User,user.Tz)\">לא מעונין</button>\n</div>\n\n\n\n\n\n\n\n\n -->\n\n\n\n\n\n\n\n\n<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js\"></script>\n<script src=\"//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js\"></script>\n<!------ Include the above in your HEAD tag ---------->\n\n<link rel=\"stylesheet\" href=\"https://use.fontawesome.com/releases/v5.2.0/css/all.css\"\n  integrity=\"sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ\" crossorigin=\"anonymous\">\n  <div *ngIf=\"arrUser&&arrUser.length==0\">לצערינו לא נמצאו הצעות מתאימות כרגע בעזרת ד` בקרוב נעדכן אותך על הצעות חדשות............!</div>\n<div class=\"container\" *ngFor=\"let u of arrUser;i as index\">\n\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <!-- border-primary  -->\n      <div class=\"card border-dark flex-md-row mb-4 shadow-sm h-md-250\">\n\n\n\n        <div class=\"card-body d-flex flex-column align-items-start\">\n          <label>שם פרטי :{{u.user.FirstName}}</label>\n          <label>גיל : {{ getAgeFromDate(u.user.BornDate)}}</label>\n          <label>מצב מישפחתי : {{dCandidateService.GetValue(u.user.Status)}}</label>\n          <label>ארץ מגורים : {{u.user.CountryId}}</label>\n\n          <div *ngIf=\"!u.IsActiv\" class=\"check xed\">\n            <span></span>\n            <span></span>\n          </div>\n\n\n        </div>\n\n\n\n        <div class=\"card-img-right flex-auto d-none d-lg-block d\" style=\"width: 200px; height: 250px;\">\n          <div  *ngIf=\"u.IsActiv\"  class=\"wapperButton\">\n            <button (click)=\"GetDetailByTzToSuggestion(u.user)\">פרטים נוספים</button>\n            <button (click)=\"Interested(dCandidateService.secondCandidate.User,u.user.Tz)\">מעונין להיפגש</button>\n            <button (click)=\"NotInterseted(dCandidateService.secondCandidate.User,u.user.Tz)\">לא מעונין</button>\n          </div>\n          <div  *ngIf=\"!u.IsActiv\"  class=\"wapperButton\">\n           <div>לא רלוונטי</div>\n            <button (click)=\"NotInterseted(dCandidateService.secondCandidate.User,u.user.Tz)\">להסרה </button>\n          </div>\n        </div>\n\n\n\n      </div>\n    </div>\n\n\n\n  </div>\n</div>"
