...
import { TaskesComponent } from './component/matchMaker/match-maker/taskes/taskes.component';
const routes: Routes = [
  ...
  },
  {
    path: 'MatcMaker', component: MatchMakerComponent, canActivate: [AuthGuard], children: [
      { path: '', redirectTo: 'taskes', pathMatch: 'full', canActivate: [AuthGuard] },
      { path: 'taskes', component: TaskesComponent , canActivate: [AuthGuard]},
