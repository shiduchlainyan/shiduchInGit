...
export class CalendarComponent implements OnInit {
  ...
  constructor(private MatchmakerService:MatchmakerService, private modalService: BsModalService, private CalanderService: CalanderService, private dCandidateService: CandidateService) { }
