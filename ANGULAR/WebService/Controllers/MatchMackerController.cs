...
namespace WebService.Controllers
{
    public class MatchMackerController : ApiController
    {
        ...
        [Route("api/getAllMatchMaker")]
        [HttpGet]
        public IHttpActionResult getAllMatchMaker()
        {
            List<User> AllUsers = matchMaker.getAllMatchMaker();
            return Ok(AllUsers);
        ...
        //======================רשימת המטלות=================
        [HttpGet]
        [Route("api/GetAllTaskes")]
        public IHttpActionResult GetAllTaskes()
        {
            List<Taske> t = matchMaker.GetAllTaskes();
            return Ok(t);
        }

        [HttpPost]
        [Route("api/GetConectionToTaskes")]
        public IHttpActionResult GetConectionToTaskes(List<Taske>taskes)
        {
            List<conectionOption> col = matchMaker.GetConectionToTaskes(taskes);
            return Ok(col);
        }

        [HttpPost]
        [Route("api/removeTask")]
        public IHttpActionResult removeTask(Taske t)
        {
            matchMaker.removeTask(t);
            return Ok();
        }

        [HttpPost]
        [Route("api/addCommentFotTask")]
        public IHttpActionResult addCommentFotTask( Taske t)
        {
            matchMaker.addCommentFotTask(t);
           return Ok("succeess");
        }
    }
